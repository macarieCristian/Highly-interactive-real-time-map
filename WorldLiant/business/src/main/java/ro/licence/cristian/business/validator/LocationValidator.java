...
public class LocationValidator {
    ...
    public void validate(Location location) {
        ValidationUtil.checkNotEmptyAndRegexAndLength(location.getLongitude().toString(), COORDINATE_REGEX,3);
        ValidationUtil.checkNotEmptyAndRegexAndLength(location.getLatitude().toString(), COORDINATE_REGEX,3);
    }
}
